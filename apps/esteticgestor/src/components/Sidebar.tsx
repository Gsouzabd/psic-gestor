...
import { useAuth, NotificationBadge } from '@gestor/core'
import { CalendarDays, Users, LogOut, User, Menu, X, Shield, Settings, ClipboardCheck, DollarSign, MessageSquare } from 'lucide-react'
...
export default function Sidebar() {
  ...
  const navItems = [
    { path: '/dashboard', icon: CalendarDays, label: 'Agenda' },
