 ...
 * @param {string} sessaoAgendadaId - ID da sessão agendada
 * @param {boolean} compareceu - true = compareceu, false = não compareceu
 * @param {string} anotacoes - Anotações opcionais da sessão
 * @returns {Promise<{prontuario: Object|null, error: Error|null}>}
 */
export async function marcarComparecimento(sessaoAgendadaId, compareceu, anotacoes = '') {
  try {
